...
def sample_field_masses_asymm(df,model_dir,mass_col='MASS',mass_err_plus='MASSMAX',mass_err_minus = 'MASSMIN',
...
def sample_field_sfrs_asymm(df,model_dir,mass_col='MASS',mass_err_plus='MASSMAX',mass_err_minus = 'MASSMIN',
                    sfr_col='SPECSFR',sfr_err_plus='SPECSFRMAX',sfr_err_minus='SPECSFRMIN',weight_col='weight',
                    index_col = 'CIDint',n_iter=1E4,seed=1234,variable='mass'):
