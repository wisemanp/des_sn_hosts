...
from .stretch_models import x1_int_asymm, x1_twogauss_age, x1_twogauss_fix, x1_int_linear_gauss
...
class SN_Model():
    ...
    def x1_int_linear_gauss(self,args,params):
        args['x1'] = x1_int_linear_gauss(args['SN_age'],params['slope'],params['offset'])
        args['prog_age'] = 'Young'
        return args
